...
public class ControlsToValues {
    public double cubicLowerSpeedValue;
    public ControlsToValues(double cubicLowerSpeedValue){
        this.cubicLowerSpeedValue = cubicLowerSpeedValue;
    }
    public ControlsToValues(){
        this(0.4);
    }
