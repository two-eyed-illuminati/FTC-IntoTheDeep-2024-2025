...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -1627.5512874622775; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 1211.1597071552665; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -1931.8917626502634; // x position of the perpendicular encoder (in tick units)
    }
